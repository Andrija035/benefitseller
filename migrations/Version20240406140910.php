...
final class Version20240406140910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE packages (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, user_category SMALLINT NOT NULL, INDEX IDX_9BB5C0A7979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
